...
<?php
    ...
    $query = "SELECT roomtype,count(*) as cnt FROM booked GROUP by roomtype";
...
<head>
    ...
    function draw_chart() 
    {
        var data = new google.visualization.arrayToDataTable([['Roomtype','Cnt'],
            <?php
        ...
        var options = 
        {
            title: 'Percentage of Rooms based on the Type of Room that are Currently Reserved',
            pieHole: 0.4
        };
    ...
    <title>Luxury Seasons Hotel Statistics by Type of Room</title>
        

    <div class="topnav" id="myTopnav">
    <a href="index.php"><img class="img-logo" src="../pictures/logo.png"></a>
    <a href="roomtype.php" class="active">Statistics by Type of Room</a>
...
<br /><br />  
   <div name="stats" style="width:900px;">  
        <p align="center">G-static Pie Chart of Current Rooms Booked and Reserved based on the Type of Room Database</p>  
        <br>  
