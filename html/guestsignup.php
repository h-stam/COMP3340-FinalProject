...
<head>
	...
	<title>Luxury Seasons Hotel Guest Signup Page</title>
		

	<div class="topnav" id="myTopnav">
	<a href="index.php"><img class="img-logo" src="../pictures/logo.png"></a>
	<a href="stats.php">Statistics</a>
	<a href="guestsignup.php" class="active">Guest Signup</a>
...
<body>
	<div class="login">
		<h1>Signup to be Guest </h1>
		<p>Please fill this form to create an account.</p>
        <form action="guestsignup.php" method="post">
            ...
            <br><br>
            <p>Already a guest? Click to login below!</p>
    		<button class="btn" onclick="window.open('guestlog.php')"><i class="far fa-check-circle"></i>REGISTER</button>
        </form>
    </div>    
 ...
 <?php
	...
	if(isset($_POST["username"]) && isset($_POST["password"])) 
	{
		...
		if(empty($username_err) && empty($password_err) && empty($confirm_password_err)) 
		{
			...
			echo "<scrip>windsor.location = 'guestlog.php'</script>";
		}
	}
